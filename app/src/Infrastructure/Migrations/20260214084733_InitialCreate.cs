        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CpuWarningThreshold = table.Column<double>(type: "float", nullable: false),
                    CpuCriticalThreshold = table.Column<double>(type: "float", nullable: false),
                    MemoryWarningThreshold = table.Column<double>(type: "float", nullable: false),
                    MemoryCriticalThreshold = table.Column<double>(type: "float", nullable: false),
                    DiskWarningThreshold = table.Column<double>(type: "float", nullable: false),
                    DiskCriticalThreshold = table.Column<double>(type: "float", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetworkInBytesPerSec = table.Column<double>(type: "float", nullable: false),
                    NetworkOutBytesPerSec = table.Column<double>(type: "float", nullable: false),
                    ActiveProcesses = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alerts_ServerId_Status",
                table: "Alerts",
